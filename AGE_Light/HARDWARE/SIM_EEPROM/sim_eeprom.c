...
s32 FLASH_Write_Word(u16* ptr, u32 Addr, u16 len)
{
   ...
   FLASH_SIM_EraseEE((u32)Addr + 0x0000);
   FLASH_SIM_EraseEE((u32)Addr + 0x0400);
	 switch(jtemp)
	 {
	   case 1:FLASH_SIM_WriteEE(ptr, Addr, (WFLASH_INDEX*2));
		        break;
		 case 2:FLASH_SIM_WriteEE(ptr, (u32)Addr, (WFLASH_INDEX*4));	       
		        break;		   
		 default:break;
	 }
